...
const Frame4 = () => {
    return (
        <main className='w-full h-auto flex items-center justify-center p-4 sm:p-6'>
            <div className='w-full max-w-[312px] sm:max-w-[600px] lg:max-w-[800px] h-auto frame4-bg rounded-[8px] flex flex-col justify-start px-6 sm:px-10 py-6 sm:py-10 gap-6'>
                <div className='flex justify-start gap-2 items-center'>
                    ...
                    <span className='font-semibold text-[24px]'>Testimonials</span>
                </div>
