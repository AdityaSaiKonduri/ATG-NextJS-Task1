...
const Auth = () => {
    ...
    return (
        <div className='w-[312px] md:w-[410px] h-[430px] flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-4'>
                <button className='w-[312px] md:w-[410px] flex justify-start p-2 sm:p-3 gap-[75px]md:gap-[100px] items-center border-hobby-purple rounded-[8px]'>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_24368_120)">
                ...
                <button className='w-[312px] md:w-[410px] flex justify-start p-2 sm:p-3 gap-[75px]md:gap-[100px] items-center border-hobby-purple rounded-[8px]'>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_24368_408)">
                ...
                <div>
                    {
                        (activeTab === "signIn") ? (
                            ...
                            <div className='w-[312px] md:w-[410px]'>
                                <p className='text-[11.5px] flex'>By continuing, you agree to our &nbsp; <p className='font-semibold'>Terms of Service</p> &nbsp; and &nbsp; <p className='font-semibold'>Privacy Policy</p>.</p>
